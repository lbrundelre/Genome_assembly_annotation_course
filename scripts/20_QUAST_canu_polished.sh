...
#SBATCH --job-name=Quast_canu_poli_with_ref
#SBATCH --mail-user=livbrundel@gmail.com
#SBATCH --mail-type=fail,begin,end
#SBATCH --output=/data/users/lbrun/assembly_annotation_course/evaluation/output_QUAST_canu_poli_with_ref%j.o
#SBATCH --error=/data/users/lbrun/assembly_annotation_course/evaluation/error_QUAST_canu_poli_with_ref%j.e
...
#-o ${WORKDIR}/evaluation/canu/QUAST/polished
...
-o ${WORKDIR}/evaluation/canu/QUAST/polished_ref/
