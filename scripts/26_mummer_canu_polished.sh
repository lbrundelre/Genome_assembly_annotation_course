...
#SBATCH --output=/data/users/lbrun/assembly_annotation_course/evaluation/output_mummer_canu_poli_%j.o
#SBATCH --error=/data/users/lbrun/assembly_annotation_course/evaluation/error_mummer_canu_poli_%j.e
...
#performe nucmer
nucmer --prefix canu_polished --breaklen 1000 --mincluster 1000 \
$ref_file ${input_dir}/polishing/canu/pilon.fasta

#performe mummerplot
mummerplot --prefix canu_polished -R $ref_file \
-Q ${input_dir}/polishing/canu/pilon.fasta \
--filter -t png --large --layout canu_polished.delta
